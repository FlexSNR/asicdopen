...
const (
	...
	PORT_MODE_L2                     = pluginCommon.PORT_MODE_L2
	PORT_MODE_L3                     = pluginCommon.PORT_MODE_L3
	PORT_MODE_UNCONFIGURED           = pluginCommon.PORT_MODE_UNCONFIGURED
	PORT_MODE_INTERNAL               = pluginCommon.PORT_MODE_INTERNAL
)
