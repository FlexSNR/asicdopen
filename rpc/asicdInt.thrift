...
struct Vxlan {
	...
	3 : i16 VlanId
	4 : i32 Mtu
	5 : list<string> IntfRefList
	6 : list<string> UntagIntfRefList	
}
...
service ASICDINTServices {
    ...
    bool CreateVxlanVtep(1: Vtep config);
    bool DeleteVxlanVtep(1: Vtep config);
    bool CreateVxlan(1: Vxlan config);
    bool DeleteVxlan(1: Vxlan config);
    bool AddHostInterfaceToVxlan(1:i32 Vni, 2:list<string> IntfRefList 3:list<string> UntagIntfRefList);
    bool DelHostInterfaceFromVxlan(1:i32 Vni, 2:list<string> IntfRefList 3:list<string> UntagIntfRefList);
